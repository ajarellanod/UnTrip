      ...
      <div class="container">
        <div class="columns">
          ...
          <div class="column is-7">
            ...
            <h3
              v-else-if="(rutasActuales.length == 0) & (nombreActual != '')"
              class="title is-3 has-text-centered logo"
            >
                    ...
                    <div class="media-content">
                      <div class="content">
                        <p>
                          ...
                          <small>{{ ruta.info_bus.chofer_nombre }}</small>
                          <br />
                          <strong>Fecha:</strong>
                          <small>{{ ruta.salida }}</small>
                          <br />
                          <strong>Capacidad:</strong>
                          <small>{{ ruta.info_bus.capacidad }}</small>
                          <br />
                          <strong>Asientos Disponibles:</strong>
                          <small>{{ asientosDisponibles(ruta) }}</small>
                          <br />
                        </p>
                      </div>
...
export default {
  ...
  methods: {
    ...
    asientosDisponibles(ruta) {
      return ruta.asientos.filter(asiento => asiento.estado == 1).length;
    },
    getRutas() {
      let vm = this;
